...
countFrames      .ds 1   ; Counter number of frames
framesBlink      .ds 1   ; Next Number Frame for Blink (framesBlink = countFrames+#BPMBLINK)
framesInput      .ds 1   ; Next Number Frame for Input (framesInput = countFrames+#BPMBLINK)
...
mutexNMIReady    .ds 1   ; Mutex to synchronize NMI
flagTurnChange   .ds 1   ; Flag indicator turn change
